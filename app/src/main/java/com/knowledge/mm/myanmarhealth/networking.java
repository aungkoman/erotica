package com.knowledge.mm.myanmarhealth;
...
public class networking {
    ...
    // https://mmsoftware100.com/blogger/erotica/blog_post_retrieve.php?ops_type=select&last_post_id=0
    //public static final String BASE_URL = "https://teamcs.000webhostapp.com"; // android 9 pie allow on only HTTPS
    public static final String BASE_URL = "https://mmsoftware100.com"; // android 9 pie allow on only HTTPS
